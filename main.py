...
if st.button('Adicionar Contato'):
    agenda.add_contact(nome, email, idade, numero_sem_virgulas)
...
edit_numero = st.text_input('Número', value=agenda_data_sorted.loc[agenda_data_sorted['Nome'] == edit_nome, 'Numero'].values[0])
